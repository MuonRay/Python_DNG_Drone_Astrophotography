...
for infile in os.listdir("./"):
    ...
    if infile[-3:] == "tif" or infile[-3:] == "DNG" :
       ...
       # and then
       imageio.imsave(outfile, img_uint8)
...
#Apply gamma corrections: gamma values greater than 1 will shift the image histogram 
#towards left and the output image will be darker than the input image. 
#On the other hand, for gamma values less than 1, the histogram will shift 
#towards right and the output image will be brighter than the input image.
    

#gamma_corrected_image = exposure.adjust_gamma(out, gamma=0.5, gain=0.5)
...
#imageio.imsave("bri_"+images_in+".jpg", hist_equalized_image)

#hist_equalized_image.save("bri_"+images_in+".jpg")